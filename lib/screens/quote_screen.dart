...
class _BaoGiaMain extends StatelessWidget {
  ...
  _BaoGiaMain({required this.onGotoGiaGoc, required this.onGotoLichSu});
        ...
        child: Column(children: [
          ...
          Row(children: [
            Expanded(child: _ShortcutCard(
              ...
              color: context.p.teal, bg: Color(0xFFE0F7FA), onTap: onGotoGiaGoc,
            )),
            SizedBox(width: 10),
            Expanded(child: _ShortcutCard(
              icon: Icons.history_rounded, title: s.scHistory,
              subtitle: '${state.quotes.length} ${s.histSaved}',
              color: Color(0xFF7C3AED), bg: Color(0xFFEDE9FE), onTap: onGotoLichSu,
            )),
          ]),
          SizedBox(height: 14),
                  ...
                  return GestureDetector(
                    ...
                    child: AnimatedContainer(
                      ...
                      decoration: BoxDecoration(
                        color: active ? Color(0xFFE0F7FA) : context.p.surface,
                      ...
                      child: Row(mainAxisSize: MainAxisSize.min, children: [
                        ...
                        Text(c.name.length > 10 ? c.name.split(' ').last : c.name,
                            style: TextStyle(fontWeight: FontWeight.w700, fontSize: 12, color: active ? context.p.teal : Color(0xFF475569))),
                        SizedBox(width: 4),
      ...
      Expanded(child: ListView(
        ...
        if (state.pricedSeafood.isEmpty)
          SectionCard(child: Column(children: [
            ...
            SizedBox(height: 8),
            Text(s.noBaseGo, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 15)),
            SizedBox(height: 6),
            ...
            child: AnimatedOpacity(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: kPurple.withOpacity(0.35), blurRadius: 18, offset: Offset(0, 7))],
                ),
    ...
    return grouped.entries.map((entry) => Column(
      ...
      children: [
        Padding(
          ...
          child: Row(children: [
            Text(kCatIcons[entry.key] ?? '', style: TextStyle(fontSize: 14)),
            SizedBox(width: 6),
...
class _QuoteItemRow extends StatefulWidget {
  final Seafood sf;
  _QuoteItemRow({required this.sf});
  @override
      ...
      child: Container(
        ...
        child: Column(children: [
          Row(children: [
            ...
            SizedBox(width: 9),
            Container(width: 34, height: 34, decoration: BoxDecoration(color: Color(0xFFEEF6F7), borderRadius: BorderRadius.circular(10)),
                child: Center(child: Text(widget.sf.icon, style: TextStyle(fontSize: 18)))),
            SizedBox(width: 9),
            ...
            child: Row(children: [
              if (ov) ...[
                GestureDetector(
                  ...
                  child: Container(padding: EdgeInsets.symmetric(horizontal: 8, vertical: 6),
                    decoration: BoxDecoration(color: Color(0xFFFEF3C7), borderRadius: BorderRadius.circular(8)),
                    child: Icon(Icons.refresh_rounded, size: 16, color: Color(0xFFB45309))),
                ),
                SizedBox(width: 6),
              ],
              Expanded(child: Container(
                ...
                decoration: BoxDecoration(color: Color(0xFFE0F7FA),
                    border: Border.all(color: ov ? Color(0xFFFBBF24) : Color(0xFFA5F3FC), width: 1.5),
                ...
                child: TextField(
                  ...
                  style: TextStyle(fontWeight: FontWeight.w800, fontSize: 13,
                      color: ov ? Color(0xFFB45309) : lv.color),
                  decoration: InputDecoration(contentPadding: EdgeInsets.zero, isDense: true, border: InputBorder.none),
              ...
              Text(sell >= base ? '+${fmt(sell - base)}' : '-${fmt(base - sell)}',
                  style: TextStyle(fontSize: 13, fontWeight: FontWeight.w800,
                      color: sell >= base ? Color(0xFF15803D) : Color(0xFFDC2626))),
            ]),
          ),
        ]),
      ),
...
class _GiaGocPage extends StatefulWidget {
  ...
  _GiaGocPage({required this.onBack});
  @override
...
class _GiaGocPageState extends State<_GiaGocPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Expanded(child: ListView(padding: EdgeInsets.fromLTRB(16,14,16,24), children: [
        // summary banner
        Container(
          ...
          child: Stack(children: [
            Positioned(right: -8, top: -12, child: Opacity(opacity: 0.08, child: Icon(Icons.monetization_on_rounded, size: 90, color: Colors.white))),
            Row(children: [
...
class _LichSuPage extends StatefulWidget {
  final VoidCallback onBack;
  _LichSuPage({required this.onBack});
  @override
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      if (state.quotes.isNotEmpty)
        Container(
          ...
          child: Column(children: [
            ...
            if (hasFilter) Padding(padding: EdgeInsets.only(top: 8), child: Align(alignment: Alignment.centerLeft,
      ...
      Expanded(child: state.quotes.isEmpty
          ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [AppIcon(icon: Icons.waves_rounded, color: context.p.teal, size: 64, iconSize: 30), SizedBox(height: 12), Text(s.noQuotes, style: TextStyle(color: context.p.textMuted, fontWeight: FontWeight.w700, fontSize: 16))]))
          : filtered.isEmpty
              ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [AppIcon(icon: Icons.search_off_rounded, color: context.p.textMuted, size: 60, iconSize: 28), SizedBox(height: 12), Text(s.noTxFound, style: TextStyle(color: context.p.textMuted, fontWeight: FontWeight.w700, fontSize: 15))]))
              : ListView.builder(
...
class _HistFilterDD extends StatelessWidget {
  ...
  _HistFilterDD({required this.value, required this.items, required this.onChanged});
...
class _QuoteHistoryCard extends StatefulWidget {
  final Quote quote;
  _QuoteHistoryCard({required this.quote});
  @override
...
<table border="1" cellspacing="0" cellpadding="6">
  ...
  Widget _vDivider(BuildContext context) =>
    Container(width: 1, height: 28, margin: EdgeInsets.symmetric(horizontal: 4),
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: Color(0xFF0E7C8C).withOpacity(0.13), blurRadius: 22, offset: Offset(0, 8)),
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              Container(
                ...
                child: Text('${kMonths[q.month]} / ${q.year}'.toUpperCase(),
                    style: TextStyle(fontSize: 9, color: Colors.white70, fontWeight: FontWeight.w800, letterSpacing: 1.0)),
              ),
              Spacer(),
              Container(
                padding: EdgeInsets.symmetric(horizontal: 10, vertical: 3),
              ...
              GestureDetector(
                ...
                child: Container(
                  width: 28, height: 28,
                  decoration: BoxDecoration(
                    color: _confirmDel ? Color(0xFFDC2626) : Color(0xFFDC2626).withOpacity(0.75),
            ...
            SizedBox(height: 10),
            Text(q.customerName,
                style: TextStyle(fontSize: 20, fontWeight: FontWeight.w900, color: Colors.white, letterSpacing: -0.4, height: 1.1)),
            SizedBox(height: 8),
            Row(children: [
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            _statCell(context,
              ...
              color: q.profit >= 0 ? Color(0xFF15803D) : Color(0xFFDC2626)),
            _vDivider(context),
        ...
        Container(height: 1, margin: EdgeInsets.symmetric(horizontal: 14), color: context.p.border.withOpacity(0.4)),
        SizedBox(height: 12),
        ...
        ...q.items.map((it) => Padding(
          ...
          child: Row(children: [
            Container(
              width: 34, height: 34,
              decoration: BoxDecoration(color: Color(0xFFE0F7FA), shape: BoxShape.circle),
              child: Center(child: Text(it.icon, style: TextStyle(fontSize: 17))),
            ),
            SizedBox(width: 10),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: it.sellPrice < it.basePrice ? Color(0xFFFEF2F2) : Color(0xFFECFDF5),
                borderRadius: BorderRadius.circular(14),
              ),
              child: Text('${fmtK(it.sellPrice)}/${it.unit}',
                  style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800,
                      color: it.sellPrice < it.basePrice ? Color(0xFFDC2626) : Color(0xFF15803D))),
            ),
          ]),
        )),
            ...
            Row(children: [
              ...
              Expanded(child: GestureDetector(
                ...
                child: Container(
                  height: 42,
                  decoration: BoxDecoration(
                      border: Border.all(color: Color(0xFF15803D), width: 1.5),
                      borderRadius: BorderRadius.circular(21)),
                  child: Center(child: _exportingExcel
                      ? SizedBox(width: 16, height: 16, child: CircularProgressIndicator(strokeWidth: 2, color: Color(0xFF15803D)))
                      : Row(mainAxisSize: MainAxisSize.min, children: [
                          Icon(Icons.table_chart_rounded, size: 15, color: Color(0xFF15803D)),
                          SizedBox(width: 6),
                          Text(s.exportExcel, style: TextStyle(color: Color(0xFF15803D), fontSize: 12, fontWeight: FontWeight.w700)),
                        ])),
                ),
              )),
            ]),
            if (_confirmDel) ...[
              ...
              Container(
                ...
                child: Row(children: [
                  ...
                  SizedBox(width: 8),
                  Expanded(child: Text('Xóa báo giá này?',
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(color: Color(0xFFDC2626), borderRadius: BorderRadius.circular(12)),
                      child: Text(s.delete, style: TextStyle(color: Colors.white, fontSize: 12, fontWeight: FontWeight.w800)),
                    ),
                  ),
                  SizedBox(width: 6),
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      child: Text(s.cancel, style: TextStyle(fontSize: 12, color: Color(0xFF475569), fontWeight: FontWeight.w600)),
                    ),
                  ),
                ]),
              ),
...
class _ShortcutCard extends StatelessWidget {
  ...
  _ShortcutCard({required this.icon, required this.title, required this.subtitle, required this.color, required this.bg, required this.onTap});
...
class _DropdownBox extends StatelessWidget {
  ...
  final ValueChanged<String?> onChanged;
  _DropdownBox({required this.value, required this.items, required this.onChanged});
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: DropdownButton<String>(
      ...
      onChanged: onChanged, underline: SizedBox(), isExpanded: true, dropdownColor: context.p.surface,
    ),
  );
}
...
class _CatDropdown extends StatelessWidget {
  final String value;
  final ValueChanged<String?> onChanged;
  _CatDropdown({required this.value, required this.onChanged});
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: DropdownButton<String>(
      value: value, isExpanded: true, underline: SizedBox(), dropdownColor: context.p.surface,
...
class _UnitDropdown extends StatelessWidget {
  final String value;
  final ValueChanged<String?> onChanged;
  _UnitDropdown({required this.value, required this.onChanged});
...
class _SumItem extends StatelessWidget {
  ...
  _SumItem(this.label, this.value);
  @override
  Widget build(BuildContext context) => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    Text(label.toUpperCase(), style: TextStyle(fontSize: 9, color: Colors.white70, fontWeight: FontWeight.w600, letterSpacing: 0.8)),
    Text(value, style: TextStyle(fontSize: 22, color: Colors.white, fontWeight: FontWeight.w800)),
  ]);
}
            ...
            child: AnimatedContainer(
              ...
              child: Center(child: _saving
                  ? Row(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      const SizedBox(width: 8),
                      const Text('Đang lưu...', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w700, fontSize: 14)),
                    ])
