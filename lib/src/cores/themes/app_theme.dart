...
final mainTheme = FlexThemeData.dark().copyWith(
    ...
    textTheme: const TextTheme().copyWith(
      ...
      titleMedium: const TextStyle(
          color: Colors.white, height: 1.4, fontSize: 17, fontWeight: FontWeight.w700),
      ...
      labelLarge: const TextStyle(fontSize: 12, color: Colors.white60, fontWeight: FontWeight.w400),
    ),
    cardTheme: CardTheme(
