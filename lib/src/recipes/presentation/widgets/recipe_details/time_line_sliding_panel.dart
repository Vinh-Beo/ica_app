...
import 'package:ica_app/src/recipes/presentation/widgets/recipe_details/animated_sliding_panel.dart';
...
class _TimeLineSlidingPanelState extends State<TimeLineSlidingPanel> with TickerProviderStateMixin {
  ...
  void initializeControllers() {
    ...
    _curvedAnimation = CurvedAnimation(parent: _controller, curve: Curves.easeInOutSine);
