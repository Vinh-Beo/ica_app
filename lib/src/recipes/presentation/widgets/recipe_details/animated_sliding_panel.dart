...
import 'package:ica_app/src/recipes/presentation/widgets/recipe_details/ingredients_card_list.dart';
import 'package:ica_app/src/recipes/presentation/widgets/recipe_details/time_line_widget.dart';
...
class AnimatedSlidingPanel extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    final header = Container(
      ...
      margin: EdgeInsets.symmetric(horizontal: constraints.maxWidth * 0.4, vertical: 10),
    ...
    return SlidingUpPanel(
        ...
        minHeight: constraints.maxHeight * (listenable as Animation<double>).value,
        ...
        panel: Column(
          children: [
            ...
            Expanded(
              ...
              steps: recipe.steps,
              isCheckedList: List.generate(recipe.steps.length, (index) => false),
            ))
          ],
        ));
  }
