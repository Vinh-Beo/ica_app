...
import 'package:ica_app/src/recipes/presentation/widgets/home_screens/recipe_card_widget.dart';
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            ...
            child: RecipeCardWidget(recipe: recipes[index]).animate().slideX(
                duration: 200.ms, delay: 0.ms, begin: 1, end: 0, curve: Curves.easeInOutSine),
          );
        });
  }
}
