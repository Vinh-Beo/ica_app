...
import 'package:ica_app/src/cores/constants/strings.dart';
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Padding(
        ...
        child: Text.rich(
          TextSpan(style: Theme.of(context).textTheme.displaySmall, children: const [
            TextSpan(
              text: Strings.onBoardingTitle,
            ),
            TextSpan(text: ' everyday', style: TextStyle(color: AppColors.timeLineColor)),
          ]),
