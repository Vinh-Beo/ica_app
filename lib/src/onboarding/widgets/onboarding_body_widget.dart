...
import 'package:ica_app/src/onboarding/widgets/animated_button_widget.dart';
import 'package:ica_app/src/onboarding/widgets/animated_description_widget.dart';
import 'package:ica_app/src/onboarding/widgets/animated_dish_widget.dart';
import 'package:ica_app/src/onboarding/widgets/animated_title_widget.dart';
      ...
      children: [
        ...
        Flexible(
          ...
          child: AnimatedTitleWidget(
              titleDelayDuration: titleDelayDuration, mainPlayDuration: mainPlayDuration),
        ),
        const SizedBox(
          height: 20,
        ),
        ...
        Expanded(
          ...
          child: GestureDetector(
            ...
            child: AnimatedButtonWidget(
                buttonDelayDuration: buttonDelayDuration, buttonPlayDuration: buttonPlayDuration),
          ),
        )
      ],
    )
